...
while not fim_de_jogo:
    ...
    pontos_font = font.render('Pontos: %s' % (pontos), True, (0, 0, 255))
    pontos_rect = pontos_font.get_rect()
    pontos_rect.topright = (600 - 500, 10)
...
while True:
    ...
    fim_de_jogo_screen = fim_de_jogo_font.render('Fim de Jogo', True, (255, 0, 0))
    fim_de_jogo_rect = fim_de_jogo_screen.get_rect()
    fim_de_jogo_rect.midtop = (600 / 2, 300)
    screen.blit(fim_de_jogo_screen, fim_de_jogo_rect)
    pygame.display.update()
